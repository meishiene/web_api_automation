...
class Project(Base):
    ...
    worker_heartbeats = relationship("WorkerHeartbeat", back_populates="project", cascade="all, delete-orphan")
    ...
    web_batch_runs = relationship("WebBatchRun", back_populates="project", cascade="all, delete-orphan")
