...
class ErrorCode:
    ...
    INTEGRATION_CONFIG_ALREADY_EXISTS = "INTEGRATION_CONFIG_ALREADY_EXISTS"
    INTEGRATION_EVENT_NOT_FOUND = "INTEGRATION_EVENT_NOT_FOUND"
    ...
    INTEGRATION_CONFIG_DISABLED = "INTEGRATION_CONFIG_DISABLED"
    ...
    RUN_QUEUE_ITEM_NOT_FOUND = "RUN_QUEUE_ITEM_NOT_FOUND"
